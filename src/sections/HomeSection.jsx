...
const HomeSection = () => {
    const socialMedia = [{
        'image': `<svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    </svg>`, 'url': 'https://www.linkedin.com/in/melina-escalante-93b024291/'
    }, {
        'image': `<svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    </svg>`, 'url': 'https://github.com/melinaescalante'
    }]
    return (<>
        <NavBar></NavBar>
        <section id="Home" className="grid grid-cols-1 md:grid-cols-2 p-4 md:p-0 items-center max-w-screen-lg my-10 md:my-20 mx-auto">
            <div className='flex justify-between flex-col m-2 mb-10 md:mb-0 h-full '>
                ...
                <h1 className=' font-bold text-5xl'>Melina Escalante</h1>
                    ...
                    <p className='break-words'><span className='font-bold text-sky-400'>Desarrolladora Web Full-Stack</span> apasionada por crear webs y aplicaciones funcionales , intuitivas y atractivas.</p>
                    <p>Me destaco por ser una persona muy ambiciosa y perfeccionista. Creo diseños adaptados para cada cliente siempre priorizando sus gustos y accesibilidad.</p>
                ...
                <div className='flex gap-4'>
                    {socialMedia.map((social) => (
                        ...
                        <a href={social.url} className=' p-4 rounded-md shadow-icon hover:translate-y-[-3px] duration-[0.5s] hover:bg-gray-950' dangerouslySetInnerHTML={{ __html: social.image }}>
                        </a>
                    ))}
                ...
                <a download='Melina-Micaela-Escalante-CV.pdf' href='/Melina-Micaela-Escalante-CV.pdf' className='p-4 flex items-center gap-2 justify-center py-2 rounded-md shadow-button hover:translate-y-[-3px] duration-[0.5s] hover:bg-gray-950'><span><svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
